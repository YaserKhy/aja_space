...
function Footer() {
	return (
		<Container id='footer' fluid style={{ backgroundImage: 'linear-gradient(to bottom left,#0A0050,#0C0829)', margin: '0px !important', padding: '30px 50px', width: '100%', height: '120px' }}>
