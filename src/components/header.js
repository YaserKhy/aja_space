...
function Header() {
	...
	return (
		<Navbar expand='sm' sticky='top' className={`${navColor ? 'py-2' : 'py-4'}`} style={{padding:'24px 150px', transition: '0.3s ease-in-out', scrollBehavior: 'smooth', backgroundImage: navColor ? 'linear-gradient(to right,#0C0829,#0A0050)' : null }}>
